        ...
        tokio::select! {
            ...
            accept = listener.accept() => {
                let (stream, _addr) = match accept {
                    Ok(v) => v,
                    Err(e) => {
                        eprintln!("rad-artifact node: accept error: {e}");
                        continue;
                    }
                };
                ...
                tokio::spawn(async move {
                    ...
                    .await
                    {
                        eprintln!("rad-artifact node: handler error: {e}");
                    }
...
mod tests {
    ...
    fn node_round_trip() {
        ...
        rt.block_on(async {
            ...
            let expected_endpoint_id = seeder::keys::encode_endpoint_id(&secret.public());
